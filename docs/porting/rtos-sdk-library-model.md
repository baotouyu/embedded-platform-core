...
以 `artinchip_d12x_lubanlite_demo68_nor` 为例：
...
### 真实 D12x target 的当前状态

四个 D12x target（`artinchip_d12x_lubanlite_demo68_*` 和 `artinchip_d12x_lubanlite_hmi_nor`）已经完成以下能力：
...
| 事项 | 状态 |
| --- | --- |
| target 描述文件（4 个 D12x + 1 个 host_rtos_demo） | 已完成 |
