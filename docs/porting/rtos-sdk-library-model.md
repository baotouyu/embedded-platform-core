...
| 概念 | 含义 | 示例 |
| --- | --- | --- |
| `os` | 系统类型 | `host`、`linux`、`rtos` |
| `vendor` | 厂商 | `artinchip`、`allwinner` |
| `sdk_family` | SDK 家族 | `luban-lite`、`tina` |
| `chip` | 芯片或芯片系列 | `d12x`、`d13x`、`d21x` |
| `board` | 板子或产品硬件版本 | `demo68-nor`、`product-v1` |
| `kernel` | RTOS 内核 | `rt-thread`、`freertos` |
...
output:
  ep_package: out/ep/artinchip_d12x_demo68_nor
  firmware: out/firmware/artinchip_d12x_demo68_nor
```
